...
SubShader {
    ...
    float3 RotateSkybox(float3 vertex)
    {
        return mul(_SkyboxRotation, float4(vertex, 1.0)).xyz;
    }
    ...
    #if USEALPHACHANNEL_ON
        half3 c = half3(tex.a, tex.a, tex.a);
